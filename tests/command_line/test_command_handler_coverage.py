...
class TestEnsurePluginsLoaded:
    @patch("spruce_grove.command_line.command_handler._PLUGINS_LOADED", False)
    @patch("spruce_grove.plugins.load_plugin_callbacks", side_effect=Exception("boom"))
    @patch("spruce_grove.messaging.emit_warning")
    def test_plugin_load_error(self, mock_warn, mock_load):
        import spruce_grove.command_line.command_handler as ch
    ...
    @patch("spruce_grove.command_line.command_handler._PLUGINS_LOADED", False)
    @patch("spruce_grove.plugins.load_plugin_callbacks", side_effect=Exception("boom"))
    @patch("spruce_grove.messaging.emit_warning", side_effect=Exception("double boom"))
...
class TestGetCommandsHelp:
    ...
    @patch("spruce_grove.command_line.command_registry.get_unique_commands")
    @patch("spruce_grove.callbacks.on_custom_command_help", return_value=[])
...
class TestHandleCommand:
    @patch("spruce_grove.command_line.command_handler._ensure_plugins_loaded")
    @patch("spruce_grove.command_line.command_registry.get_command", return_value=None)
    @patch("spruce_grove.callbacks.on_custom_command", return_value=[None])
    ...
    @patch("spruce_grove.command_line.command_registry.get_command", return_value=None)
    @patch(
        "spruce_grove.callbacks.on_custom_command", side_effect=Exception("plugin err")
    )
    @patch("spruce_grove.messaging.emit_warning")
    ...
    @patch("spruce_grove.command_line.command_handler._ensure_plugins_loaded")
    @patch("spruce_grove.command_line.command_registry.get_command", return_value=None)
    @patch("spruce_grove.callbacks.on_custom_command", return_value=["some text"])
    @patch("spruce_grove.messaging.emit_info", side_effect=Exception("oops"))
    ...
    @patch("spruce_grove.command_line.command_handler._ensure_plugins_loaded")
    @patch("spruce_grove.command_line.command_registry.get_command", return_value=None)
    @patch("spruce_grove.callbacks.on_custom_command")
    ...
    def test_namespaced_custom_command_dispatches_via_callback(
        ...
        from spruce_grove.callbacks import CustomCommandResult
        from spruce_grove.command_line.command_handler import handle_command
    ...
    @patch("spruce_grove.command_line.command_handler._ensure_plugins_loaded")
    @patch("spruce_grove.command_line.command_registry.get_command")
