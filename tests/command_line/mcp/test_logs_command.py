"""Tests for spruce_grove/command_line/mcp/logs_command.py"""

from unittest.mock import MagicMock, patch

import pytest

MODULE = "spruce_grove.command_line.mcp.logs_command"
...
def _make_cmd():
    ...
    with patch("spruce_grove.command_line.mcp.base.get_mcp_manager") as mock_mgr:
        ...
        from spruce_grove.command_line.mcp.logs_command import LogsCommand
