...
from spruce_grove.gemini_model import GeminiModel
...
def _load_plugin_model_providers():
    ...
    try:
        from spruce_grove.callbacks import on_register_model_providers
...
def make_model_settings(
    ...
    from spruce_grove.config import get_custom_model_settings
...
class ModelFactory:
    ...
    def load_config() -> Dict[str, Any]:
        ...
        try:
            from spruce_grove.callbacks import on_load_models_config
        ...
        try:
            from spruce_grove.model_descriptions import apply_description_overlays
            ...
            try:
                from spruce_grove.callbacks import on_load_model_descriptions
    ...
    def get_model(model_name: str, config: Dict[str, Any]) -> Any:
        ...
        if model_type == "gemini":
            ...
            from spruce_grove.config import get_effective_model_settings
        ...
        # via the register_model_type callback. See plugins/claude_code_oauth/register_callbacks.py
            ...
            from spruce_grove.zai_model import ZaiChatModel
            ...
            headers["X-Cerebras-3rd-Party-Integration"] = "spruce-grove"
