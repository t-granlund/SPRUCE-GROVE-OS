"""Generic OS keyring secret store for Spruce Grove.
...
secrets across builds.  The default is ``"spruce-grove"``; downstream
...
def _ensure_backend() -> None:
    ...
    try:
        from spruce_grove.secret_store_backends import (
