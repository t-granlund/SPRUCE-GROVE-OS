...
routed through :func:`spruce_grove.command_line.config_apply.apply_setting`
...
from spruce_grove.command_line.config_apply import (
...
from spruce_grove.command_line.set_menu_values import (
    display_value,
    is_default_value,
    mask_value,
)
...
def _style():
    ...
    from spruce_grove.command_line.tui_style import menu_style
...
def _record_reset(result: PickerResult, key: str) -> None:
    ...
    """
    from spruce_grove.command_line.config_apply import invalidate_post_write_caches
