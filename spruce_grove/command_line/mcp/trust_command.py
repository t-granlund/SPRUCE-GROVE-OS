...
Project MCP configs (``<CWD>/.spruce_grove/mcp_servers.json``) can define
...
from spruce_grove.mcp_.project_config import (
    CHANGED,
    TRUSTED,
    UNTRUSTED,
            ...
            if config_file is None:
                emit_info(
                    Text.from_markup(
                        ...
                        "[cyan].spruce_grove/mcp_servers.json[/cyan] in this repo "
