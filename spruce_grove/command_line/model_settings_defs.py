...
Split from :mod:`spruce_grove.command_line.model_settings_menu` (which owns
...
from spruce_grove.model_utils import THINKING_DISPLAY_CHOICES
...
def _read_per_model_retry(model_name: str, menu_key: str):
    ...
    from spruce_grove.agents.retry_profiles import per_model_key
