...
def build_model_config(model: ModelInfo, provider: ProviderInfo) -> dict:
    """Build a Spruce Grove compatible model configuration."""
    type_mapping = {
        "openai": "openai",
        "anthropic": "anthropic",
        "google": "gemini",
...
from spruce_grove.command_line.add_model_details import (  # noqa: E402
...
def _plugin_credential_flow(provider: ProviderInfo, env_var: str) -> bool:
    ...
    """
    from spruce_grove.callbacks import on_provider_credential_flow
