...
Lives separately from :mod:`spruce_grove.command_line.autosave_menu` so that
...
def _session_text(history: list) -> str:
    ...
    :func:`spruce_grove.command_line.autosave_menu._extract_message_content`.
...
class SessionContentIndex:
    ...
    always uses :func:`spruce_grove.session_storage.load_session`.
    """
