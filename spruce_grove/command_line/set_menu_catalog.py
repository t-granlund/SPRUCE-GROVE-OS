...
from spruce_grove.command_line.set_menu_schema import Setting, SettingsCategory
from spruce_grove.callbacks import get_feature_capability
from spruce_grove.command_line.set_menu_shims import (
...
from spruce_grove.keymap import get_cancel_agent_key
...
_IDENTITY = SettingsCategory(
    ...
    settings=(
        ...
        Setting(
            ...
            description="Your name - how the grove knows you.",
            type_hint="string",
...
_MCP = SettingsCategory(
    ...
    settings=(
        Setting(
            ...
            description=(
                "When True, Spruce Grove skips loading MCP servers entirely "
