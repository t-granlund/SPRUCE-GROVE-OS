...
from spruce_grove.command_line.utils import safe_input
from spruce_grove.config import get_global_model_name
from spruce_grove.list_filtering import query_matches_text
...
class ModelNameCompleter(Completer):
    ...
    def get_completions(
        ...
        from spruce_grove.model_descriptions import get_model_description
...
async def interactive_model_picker() -> Optional[str]:
    ...
    try:
        try:
            ...
            from spruce_grove.tools.common import arrow_select_async
