...
via :func:`spruce_grove.command_line.tui_style.menu_style`.
"""
...
from spruce_grove.command_line.autosave_search import SessionContentIndex, entry_matches
...
class SessionBrowser:
    ...
    def _header_line(self, width: int) -> str:
        s = self._style
        left = (
            self._c(s.bright, "SPRUCE GROVE", bold=True)
            + self._c(s.symbol, " > ")
