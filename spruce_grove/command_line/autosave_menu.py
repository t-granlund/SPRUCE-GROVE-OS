...
:mod:`spruce_grove.command_line.session_browser`; this module keeps the
...
from spruce_grove.command_line.autosave_search import SessionContentIndex
...
async def interactive_autosave_picker() -> Optional[str]:
    ...
    try:
        ...
        from spruce_grove.callbacks import on_session_browser_open
...
def display_resumed_history(history: list, num_messages: int | None = None) -> None:
    ...
    from spruce_grove.config import get_banner_color, get_resume_message_count
    from spruce_grove.tools.display import render_markdown
