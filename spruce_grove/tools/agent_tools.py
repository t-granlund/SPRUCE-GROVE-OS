...
from spruce_grove.tools.common import atomic_write_text, generate_group_id
...
def _save_session_history(
    ...
    from spruce_grove.session_storage import build_envelope, write_envelope_file
...
def _load_session_history(session_id: str) -> List[ModelMessage]:
    ...
    from spruce_grove.session_storage import decode_envelope, read_envelope_file
    ...
    if pkl_path.exists():
        ...
        from spruce_grove.session_format_migration import (
...
def register_list_agents(agent):
    ...
    def list_agents(context: RunContext) -> ListAgentsOutput:
        ...
        from spruce_grove.config import get_banner_color

        list_agents_color = get_banner_color("list_agents")

        try:
            from spruce_grove.agents import get_agent_descriptions, get_available_agents
...
from spruce_grove.tools.subagent_invocation import (  # noqa: E402
