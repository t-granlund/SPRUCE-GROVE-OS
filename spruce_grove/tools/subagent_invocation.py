...
def _gpt_5_6_recursion_blocked() -> bool:
    ...
    """
    from spruce_grove.agents._builder import _is_gpt_5_6_family
...
async def _invoke_agent_impl(
    ...
    """
    from spruce_grove.agents.agent_manager import load_agent

    group_id = generate_group_id("invoke_agent", agent_name)
    # Guest custody of the recursion guards: agents built by spruce_grove carry
    ...
    from spruce_grove.agents.subagent_stream_handler import subagent_stream_handler
    ...
    if sys.platform != "android":
        from spruce_grove.tools.browser.browser_manager import set_browser_session
    ...
    try:
        ...
        with agent_config.temporary_model_name_override(model_name):
            ...
            from spruce_grove.agents._builder import load_model_with_fallback
            ...
            from spruce_grove.agents._builder import autostart_bound_servers_async
            ...
            from spruce_grove.agents._model_message_transform import (
            ...
            from spruce_grove.config import get_output_level
        ...
        if browser_session_token is not None:
            from spruce_grove.tools.browser.browser_manager import _browser_session_var
