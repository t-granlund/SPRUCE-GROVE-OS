...
```python
from spruce_grove.tools.subagent_context import subagent_context, is_subagent
...
# empty for main agent; ``("A", "B")`` for spruce-grove -> A -> B.
...
def subagent_context(
    ...
    Args:
        agent_name: Name of the sub-agent being executed (e.g., "retriever", "spruce-grove")
...
def get_subagent_name() -> str | None:
    ...
    Example:
        >>> get_subagent_name()
        None
        >>> with subagent_context("spruce-grove"):
        ...     get_subagent_name()
        'spruce-grove'
    """
