...
from spruce_grove.config import get_banner_color, get_output_level, get_subagent_verbose
...
def render_markdown(content: str, console: Console) -> None:
    ...
    from spruce_grove.callbacks import on_termflow_highlighter, on_termflow_style
