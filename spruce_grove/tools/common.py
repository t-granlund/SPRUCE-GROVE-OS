...
# Spruce Grove's config colors, theme hooks, and Rich consoles.
...
from spruce_grove.tools.file_permission_state import set_diff_already_shown
...
_WORKING_DIR: contextvars.ContextVar[Optional[str]] = contextvars.ContextVar(
    "spruce_grove_working_dir", default=None
)
...
try:
    ...
    NO_COLOR = bool(int(os.environ.get("SPRUCE_GROVE_NO_COLOR", "0")))
...
def _termflow_diff_renderer(
    ...
    """Build termflow's diff renderer wired to Spruce Grove's theming.
    ...
    """
    from spruce_grove.callbacks import on_termflow_highlighter
...
def format_diff_with_colors(
    ...
    tints are all termflow's job; this adapter only supplies Spruce Grove's
...
def _build_arrow_select_menu(
    ...
    **overrides,
    ...
    from spruce_grove.command_line.tui_style import themed
...
def write_project_file(
    ...
    """
    from spruce_grove.tools.io_backends import get_filesystem_backend
