...
decision callback through :mod:`spruce_grove.callbacks`. Core never imports
...
def register_file_permission_state_provider(
    *,
    ...
    """
    from spruce_grove.callbacks import get_loading_context
...
def _get_active_provider() -> Optional[FilePermissionStateProvider]:
    ...
    from spruce_grove.callbacks import is_callback_owner_enabled
