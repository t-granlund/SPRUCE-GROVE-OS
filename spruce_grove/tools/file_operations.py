...
# ---------------------------------------------------------------------------
from spruce_grove.messaging import (  # New structured messaging types
    FileContentMessage,
    FileEntry,
    FileListingMessage,
    GrepMatch,
...
from spruce_grove.tools.common import resolve_path
...
def _relative_ignore_predicates(root: str) -> Tuple[Callable[[str], bool], ...]:
    ...
    """
    from spruce_grove.tools.common import should_ignore_dir_path, should_ignore_path
...
def _emit_grep_result(
    ...
    *,
    ...
    """
    from spruce_grove.config import get_grep_output_verbose
...
def _grep_via_backend(directory: str, search_string: str) -> "GrepOutput":
    ...
    from spruce_grove.config import get_grep_max_matches
...
def _grep(context: RunContext, search_string: str, directory: str = ".") -> GrepOutput:
    ...
    try:
        ...
        # Add ignore patterns to the command via a temporary file
        from spruce_grove.tools.common import DIR_IGNORE_PATTERNS
...
def register_list_files(agent):
    ...
    from spruce_grove.config import get_allow_recursion
