...
::
    ...
    python -m spruce_grove.i18n.audit                 # human summary
    python -m spruce_grove.i18n.audit --list          # + every raw site
    python -m spruce_grove.i18n.audit --top 15        # worst 15 files
    python -m spruce_grove.i18n.audit --json          # machine-readable
    python -m spruce_grove.i18n.audit --fail-under 25 # CI gate (exit 1 if under)
...
def _iter_py_files(root: str) -> Iterable[str]:
    ...
    ``python -m spruce_grove.i18n.audit path/to/module.py`` works as
...
def _default_root() -> str:
    # Audit the whole spruce_grove package by default.
