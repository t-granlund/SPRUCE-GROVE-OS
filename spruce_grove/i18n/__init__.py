"""Spruce Grove internationalization (i18n) foundation.
...
Typical call-site usage::
    ...
    from spruce_grove.i18n import t, ngettext
...
To resolve the active locale from the environment/config at boot::
    ...
    from spruce_grove.i18n import use_detected_locale
...
# Common gettext-style alias so call sites can `from spruce_grove.i18n import _`.
_ = t
