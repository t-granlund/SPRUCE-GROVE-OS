...
Usage:
    ...
    >>> manager.register_agent("session-123", "spruce-grove", "gpt-4o")
...
from spruce_grove.messaging.messages import SubAgentStatusMessage
...
class SubAgentConsoleManager:
    ...
    def register_agent(self, session_id: str, agent_name: str, model_name: str) -> None:
        ...
        Args:
            ...
            agent_name: Name of the agent (e.g., 'spruce-grove', 'qa-kitten').
