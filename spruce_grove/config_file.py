"""Bounded, recoverable I/O for Spruce Grove's INI configuration file.

The public helpers in this module keep config-file safety concerns out of the
already-large :mod:`spruce_grove.config` module. Built on the generic
primitives in :mod:`spruce_grove.atomic_io`:
...
def load_config(path: str) -> configparser.ConfigParser:
    ...
    window between cooperating Spruce Grove processes. If another process fixed
