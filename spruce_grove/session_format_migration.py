...
Follows the precedent of :mod:`spruce_grove.session_migration` (which moves
...
lives in :mod:`spruce_grove.session_surrogate_unpickler`. This module is the
...
def _sweep_directories() -> Iterable[pathlib.Path]:
    ...
    from spruce_grove.config import AUTOSAVE_DIR, CONTEXTS_DIR, DATA_DIR
