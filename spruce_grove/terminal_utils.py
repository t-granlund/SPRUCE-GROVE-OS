...
def ensure_windows_vt_processing() -> bool:
    ...
    The persistent bottom bar (and the plugins animating it — the grove
...
def print_truecolor_warning(console: Optional["Console"] = None) -> None:
    ...
    if console is None:
        try:
            ...
            print("=" * 70)
            print("Spruce Grove looks best with truecolor support.")
    ...
    warning_lines = [
        ...
        "",
        "[bold white]Spruce Grove uses rich colors and will look degraded without truecolor.[/]",
        "",
