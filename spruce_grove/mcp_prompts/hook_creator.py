...
before user prompts for creating Spruce Grove hooks.
"""

HOOK_CREATION_PROMPT = """
# Creating Hooks in Spruce Grove

You are helping a user create hooks for Spruce Grove. Spruce Grove has two hook systems:
...
Configure shell commands responding to Spruce Grove events in `.claude/settings.json`:
