...
# Braille cell constants. Every glyph is U+2800 + an 8-bit dot
# pattern; the blank cell is the empty tier, and _BRAILLE_TIER
# classifies the other 255 patterns as glow (2) or core (3).
_BRAILLE_BLANK = "\u2800"
