...
Project plugins (``<CWD>/.spruce_grove/plugins/``) execute arbitrary code at
...
* **Store lives user-side** (``~/.spruce_grove/trusted_plugins.json``) — never
...
TRUST_STORE_FILE = Path.home() / ".spruce_grove" / "trusted_plugins.json"
