...
from spruce_grove.tools.display import erase_progress_line
...
def _fire_stream_event(event_type: str, event_data: Any) -> None:
    ...
    try:
        ...
        from spruce_grove.messaging import get_session_context
...
async def event_stream_handler(
    ...
    def _filter_thinking(index: int, text: str, *, final: bool = False) -> str:
        ...
        from spruce_grove.callbacks import on_thinking_display_filter
    ...
    try:
        async for event in events:
            ...
            while _pc.is_paused():
                ...
                from spruce_grove.messaging.run_ui import is_draining
