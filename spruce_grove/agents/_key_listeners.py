...
from spruce_grove.keymap import get_cancel_agent_char_code
...
def spawn_key_listener(
    ...
    thread = threading.Thread(
        target=listener, name="spruce-grove-key-listener", daemon=True
    )
    thread.start()
...
def _listen_windows(
    ...
    from spruce_grove.terminal_utils import disable_windows_vt_input
