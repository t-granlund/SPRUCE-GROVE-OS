...
from spruce_grove.command_line.attachments import resolve_steer_content
from spruce_grove.messaging import emit_info, emit_warning
from spruce_grove.tools.agent_tools import _active_subagent_tasks
...
def sigint_should_cancel() -> bool:
    ...
    """
    try:
        from spruce_grove.messaging.run_ui import absorb_ctrl_c_if_composing
