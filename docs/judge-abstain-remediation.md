...
| G2 | No local SYNTHETIC_API_KEY, so no live end-to-end judge re-run could be performed locally | OPEN | user + next /goal cycle | Next evaluation cycle must show a non-ABSTAIN verdict from the [default] judge |
